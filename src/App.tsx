  ...
  return (
    <div className="min-h-screen bg-slate-100/70 text-slate-900 flex flex-col font-sans text-xs">
      ...
      <header className="sticky top-0 z-40 bg-white border-b border-slate-200 shadow-2xs">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <a
              href="https://github.com/aaronrojas32/LitePlan"
              target="_blank"
      ...
      <footer className="border-t border-slate-200 bg-white py-4 text-xs text-slate-500">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 flex flex-col md:flex-row items-center justify-between gap-3">
          <div className="flex flex-wrap items-center gap-2">
            <span className="font-semibold text-slate-700">LitePlan</span>
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-xs">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-medium text-slate-600 hover:text-blue-600 transition flex items-center gap-1"
            >
            ...
            <a
              href="https://github.com/aaronrojas32/LitePlan/issues"
              target="_blank"
              rel="noopener noreferrer"
