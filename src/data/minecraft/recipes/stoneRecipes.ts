...
export const STONE_RECIPES: Recipe[] = [
  ...
  {
    id: 'minecraft:polished_granite_stonecutter',
    type: 'stonecutting',
    output: { itemId: 'minecraft:polished_granite', quantity: 1 },
    ingredients: [{ itemId: 'minecraft:granite', quantity: 1 }],
    priority: 80,
    isDefault: false,
    minecraftVersion: '1.21',
  },
  ...
  {
    id: 'minecraft:polished_diorite_stonecutter',
    type: 'stonecutting',
    output: { itemId: 'minecraft:polished_diorite', quantity: 1 },
    ingredients: [{ itemId: 'minecraft:diorite', quantity: 1 }],
    priority: 80,
    isDefault: false,
    minecraftVersion: '1.21',
  },
  ...
  {
    id: 'minecraft:polished_andesite_stonecutter',
    type: 'stonecutting',
    output: { itemId: 'minecraft:polished_andesite', quantity: 1 },
    ingredients: [{ itemId: 'minecraft:andesite', quantity: 1 }],
    priority: 80,
    isDefault: false,
    minecraftVersion: '1.21',
  },

  // Synthetic Base Stone Recipes (Minecraft Java Mechanics)
  {
    id: 'minecraft:diorite_from_cobblestone_and_quartz',
    type: 'crafting_shaped',
    gridSize: '2x2',
    gridPattern: [
  ...
  {
    id: 'minecraft:andesite_from_diorite_and_cobblestone',
    ...
    isDefault: false,
    minecraftVersion: '1.21',
    description: '1x Diorita + 1x Roca -> 2x Andesita',
  },
  {
    id: 'minecraft:granite_from_diorite_and_quartz',
    type: 'crafting_shapeless',
    output: { itemId: 'minecraft:granite', quantity: 1 },
    ingredients: [
      { itemId: 'minecraft:diorite', quantity: 1 },
    ...
    isDefault: false,
    minecraftVersion: '1.21',
    description: '1x Diorita + 1x Cuarzo -> 1x Granito',
  },
  {
    ...
    output: { itemId: 'minecraft:coarse_dirt', quantity: 4 },
    ingredients: [
      { itemId: 'minecraft:dirt', quantity: 2 },
      { itemId: 'minecraft:gravel', quantity: 2 },
    ],
    priority: 100,
    isDefault: true,
    minecraftVersion: '1.21',
  ...
  // 14. Tuff, Blackstone, and Resin
  {
    id: 'minecraft:polished_tuff',
    type: 'crafting_shaped',
    gridSize: '2x2',
    output: { itemId: 'minecraft:polished_tuff', quantity: 4 },
    ingredients: [{ itemId: 'minecraft:tuff', quantity: 4 }],
    priority: 100,
    isDefault: true,
    minecraftVersion: '1.21',
  },
  {
    ...
    type: 'crafting_shaped',
    gridSize: '2x2',
    output: { itemId: 'minecraft:tuff_bricks', quantity: 4 },
    ingredients: [{ itemId: 'minecraft:polished_tuff', quantity: 4 }],
    priority: 100,
    isDefault: true,
    minecraftVersion: '1.21',
  },
  {
    ...
    type: 'crafting_shaped',
    gridSize: '2x2',
    output: { itemId: 'minecraft:chiseled_tuff', quantity: 1 },
    ingredients: [{ itemId: 'minecraft:tuff_slab', quantity: 2 }],
    priority: 100,
    isDefault: true,
    minecraftVersion: '1.21',
  },
  {
    ...
    type: 'crafting_shaped',
    gridSize: '2x2',
    output: { itemId: 'minecraft:chiseled_tuff_bricks', quantity: 1 },
    ingredients: [{ itemId: 'minecraft:tuff_brick_slab', quantity: 2 }],
    priority: 100,
    isDefault: true,
    minecraftVersion: '1.21',
  },
  {
    ...
    type: 'crafting_shaped',
    gridSize: '2x2',
    output: { itemId: 'minecraft:polished_blackstone', quantity: 4 },
    ingredients: [{ itemId: 'minecraft:blackstone', quantity: 4 }],
    priority: 100,
    isDefault: true,
    minecraftVersion: '1.21',
  },
  {
    ...
    type: 'crafting_shaped',
    gridSize: '2x2',
    output: { itemId: 'minecraft:polished_blackstone_bricks', quantity: 4 },
    ingredients: [{ itemId: 'minecraft:polished_blackstone', quantity: 4 }],
    priority: 100,
    isDefault: true,
    minecraftVersion: '1.21',
  },
  {
    ...
    type: 'crafting_shaped',
    gridSize: '3x3',
    output: { itemId: 'minecraft:resin_block', quantity: 1 },
    ingredients: [{ itemId: 'minecraft:resin_clump', quantity: 9 }],
    priority: 100,
    isDefault: true,
    minecraftVersion: '1.21',
  },
  {
    ...
    type: 'smelting',
    smeltingInput: 'minecraft:resin_clump',
    output: { itemId: 'minecraft:resin_brick', quantity: 1 },
    ingredients: [{ itemId: 'minecraft:resin_clump', quantity: 1 }],
    priority: 100,
    isDefault: true,
    minecraftVersion: '1.21',
  },
  {
    ...
    type: 'crafting_shaped',
    gridSize: '2x2',
    output: { itemId: 'minecraft:resin_bricks', quantity: 4 },
    ingredients: [{ itemId: 'minecraft:resin_brick', quantity: 4 }],
    priority: 100,
    isDefault: true,
    minecraftVersion: '1.21',
  },
  ...
  ...createStoneFamily('blackstone', 'minecraft:blackstone', 'minecraft:blackstone_stairs', 'minecraft:blackstone_slab', 'minecraft:blackstone_wall'),
  ...createStoneFamily('polished_blackstone', 'minecraft:polished_blackstone', 'minecraft:polished_blackstone_stairs', 'minecraft:polished_blackstone_slab', 'minecraft:polished_blackstone_wall'),
  ...createStoneFamily('polished_blackstone_brick', 'minecraft:polished_blackstone_bricks', 'minecraft:polished_blackstone_brick_stairs', 'minecraft:polished_blackstone_brick_slab', 'minecraft:polished_blackstone_brick_wall'),
  ...createStoneFamily('tuff', 'minecraft:tuff', 'minecraft:tuff_stairs', 'minecraft:tuff_slab', 'minecraft:tuff_wall'),
  ...createStoneFamily('polished_tuff', 'minecraft:polished_tuff', 'minecraft:polished_tuff_stairs', 'minecraft:polished_tuff_slab', 'minecraft:polished_tuff_wall'),
  ...createStoneFamily('tuff_brick', 'minecraft:tuff_bricks', 'minecraft:tuff_brick_stairs', 'minecraft:tuff_brick_slab', 'minecraft:tuff_brick_wall'),
  ...createStoneFamily('resin_brick', 'minecraft:resin_bricks', 'minecraft:resin_brick_stairs', 'minecraft:resin_brick_slab', 'minecraft:resin_brick_wall'),
];
